	...
	public boolean businessKoltukEkle(int miktar){
		...
		if(miktar%6==0){
			for (int i=curKoltukSayisi; i< (miktar + curKoltukSayisi); i++){
				...
				if(((koltukListesi.size()-1)%6)==0) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"A");
				else if(((koltukListesi.size()-1)%6)==1) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"B");
				else if(((koltukListesi.size()-1)%6)==2) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"C");
				else if(((koltukListesi.size()-1)%6)==3) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"D");
				else if(((koltukListesi.size()-1)%6)==4) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"E");
				else if(((koltukListesi.size()-1)%6)==5) koltuk.setKoltukNo(((int)(this.getKoltukSayisi() / 7) +1)+"F");
			}	
			return true;
		}
		else
